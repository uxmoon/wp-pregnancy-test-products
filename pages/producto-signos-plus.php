                    ...
                    <div class="small-12 medium-9 small-centered columns">
                        ...
                        <?php get_template_part( 'modules/content', 'linea-evatest-signos-plus' ); ?>
                            ...
                            <ul class="ev-accordion">
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos-plus/como-y-cuando-debo-usarlo/#item-02">¿C&oacute;mo y cu&aacute;ndo debo usarlo?</a></li>
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos-plus/recomendaciones/#item-03">Recomendaciones</a></li>
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos-plus/garantia-de-calidad/#item-04">Garant&iacute;a de calidad</a></li>
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos-plus/preguntas-frecuentes/#item-05">Preguntas frecuentes</a></li>
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos-plus/instrucciones-de-uso/#item-06">Instrucciones de uso</a></li>
                            </ul>
                        ...
                        <?php get_template_part( 'modules/content', 'linea-evatest-signos-plus' ); ?>
                            <ul class="ev-accordion">
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos-plus/como-actua/#item-01">¿Cómo act&uacute;a?</a></li>
                            </ul>
