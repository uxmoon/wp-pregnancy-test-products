                    ...
                    if ( is_page(228) ) { ?>
                        <?php get_template_part( 'modules/content', 'linea-evatest-signos' ); ?>
                            ...
                            <ul class="ev-accordion">
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos/como-y-cuando-debo-usarlo/#item-02">¿C&oacute;mo y cu&aacute;ndo debo usarlo?</a></li>
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos/recomendaciones/#item-03">Recomendaciones</a></li>
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos/garantia-de-calidad/#item-04">Garant&iacute;a de calidad</a></li>
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos/preguntas-frecuentes/#item-05">Preguntas frecuentes</a></li>
                                <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos/instrucciones-de-uso/#item-06">Instrucciones de uso</a></li>
                            </ul>
                    <?php // page: evatest signos - como y cuando
                    } elseif ( is_page(223) ) { ?>
                    <?php get_template_part( 'modules/content', 'linea-evatest-signos' ); ?>
                        <ul class="ev-accordion">
                            <li><a href="<?php echo esc_url( home_url() ); ?>/linea-evatest/evatest-signos/como-actua/#item-01">¿Cómo act&uacute;a?</a></li>
                        </ul>
